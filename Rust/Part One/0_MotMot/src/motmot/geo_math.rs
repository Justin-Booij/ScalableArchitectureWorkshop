...
const EARTH_RADIUS_KM: f64 = 6371.8;
...
impl GeoMath {
    ...
    /// Calculates a destination point given a starting point, bearing, and distance in Km.
    pub fn calculate_destination_point(
        ...
        let angular_distance = distance_miles / EARTH_RADIUS_KM;
